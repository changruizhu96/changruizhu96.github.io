...
- `src/pages/work/mr-compare.astro` renders a source-faithful academic project page with paper metadata, abstract, local demo video, five-stage system workflow, visual comparison, and evaluation summary.
